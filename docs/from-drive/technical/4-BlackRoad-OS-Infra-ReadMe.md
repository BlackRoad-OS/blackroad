...
1. Log into Cloudflare for the relevant zones (blackroad.io, blackroad.systems, blackroad.network).
2. For each line in the CSV:
...
4. Create api-gateway (optional for v0)
